...
leaflet(shapefile_lsoa_one) %>%
  ...
  addPolygons(
    ...
    popup = ~paste("<strong>LSOA Name:</strong>", `LSOA Name`, "<br>",
                   ...
                   "<strong>Observation:</strong>", formatC(Value, format = "d", big.mark = ","), "<br>",
                   "<strong>Resident Population:</strong>", formatC(Population, format = "d", big.mark = ","), "<br>",
...
```{r}
# 
# all_data <- read_rds_data(rds_file_name = "All_data.rds", NULL)
# 
# bsol_data <- all_data %>%
#   clean_names(case = "title",
#               abbreviations = c("LSOA")) %>%
#   filter(`Local Authority District Name` %in% c('Birmingham', 'Solihull'))
# 
# # Create datatable with options
# DT::datatable(bsol_data,
#           extensions = 'Buttons',
#           options = list(
#             dom = 'Blfrtip',
#             buttons = c('copy', 'csv', 'excel', 'pdf'),
#             pageLength = 25, # Number of rows in each page
#             lengthMenu = list(c(10, 25, 50, -1), c('10 rows', '25 rows', '50 rows', 'All')),
#             language = list(info = "Showing _START_ to _END_ of _TOTAL_ entries"),
